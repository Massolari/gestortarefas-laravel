...
@section('content')
    ...
    <div class="my-auto d-flex justify-content-center">
        <div class="card p-3 rounded-3 shadow shadow-lg bg-dark" style="max-width:300px;">
            <div class="mx-auto">
                <img src="{{ asset('assets/img/small/ram-logo-dark-theme.png') }}" alt="ramtask logo" style="width: 7rem; margin-top: -5rem">
            </div>
                ...
                <div class="row">
                    <div class="col-12 mb-3">
                        ...
                        <div class="form-floating form-floating-sm">
                            <input type="text" name="email" id="email" class="form-control" required placeholder="Usuário" value="{{ old('email') }}" />
                    ...
                    <div class="col-12 my-2">
                        <a class="btn btn-info w-100" href="{{ route('signup') }}">Criar uma conta <i class="bi bi-person-check-fill"></i></a>
                    </div>

                    {{-- link button to loggin with google --}}
                    <div class="col-12 mt-2">
                        <a href="{{ $authUrl }}" class="btn btn-light text-dark w-100">Continue com Google <i class="bi bi-google"></i></a>
                    </div>
