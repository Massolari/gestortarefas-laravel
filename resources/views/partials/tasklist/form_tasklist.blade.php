{{-- Modal para edição/criação de lista de tarefas --}}
            ...
            <div class="p-3 modal-body">
                <form action="{{ route($route) }}" method="POST">
                    ...
                    <div class="text-center row">
                        <button type="button" 
                                class="px-2 m-3 shadow shadow-md col btn btn-secondary"
                                data-bs-dismiss="modal">
                            <i class="bi bi-x-circle me-2"></i>Cancelar
                        </button>
                        <button type="submit" 
                                class="px-2 m-3 shadow shadow-md col btn btn-success">
